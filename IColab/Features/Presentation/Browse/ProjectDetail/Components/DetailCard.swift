...
struct DetailCard: View {
    ...
    var body: some View {
        ...
        .frame(width: detailCardType == .cardwithlogo ? 150 : 330)
        .padding(.horizontal, detailCardType == .cardwithlogo ? 15 : 15)
...
struct DetailCard_Previews: PreviewProvider {
    static var previews: some View {
        VStack{
            ...
            DetailCard(detailCardType: .description, title: "Description Card", caption: "Lorem ipsum dolor.")
